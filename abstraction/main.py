...
if __name__== "__main__":
    ...
    logistics_mysql_config = {}
    logistics_mysql_config['max_threads'] = 100
    logistics_mysql_config['port'] = 3306
    logistics_mysql_config['max_conn'] = 10
    logistics_hardware.store_mysql_config(logistics_mysql_config)
    ...
    print('Printing MySQL config of logistics team')
    print(logistics_hardware.read_mysql_config())
